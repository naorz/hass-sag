...
import require$$6$1 from "events";
import require$$5 from "fs";
import require$$1 from "os";
import require$$3 from "process";
import require$$3$1 from "util";
import require$$2 from "path";
import require$$5$1 from "tty";
import require$$4 from "stream";
import require$$4$1 from "readline";
import require$$7 from "constants";
import require$$8 from "assert";
import require$$9 from "module";
import require$$14 from "http";
import require$$15 from "https";
import require$$16 from "zlib";
import require$$17 from "url";
import require$$18 from "net";
...
if (globalThis.Deno) {
  ...
  globalThis.__dirname = new URL("data:text/javascript;base64,", import.meta.url).pathname;
...
var build = { exports: {} };
var esblib;
var hasRequiredEsblib;
function requireEsblib() {
  if (hasRequiredEsblib) return esblib;
  hasRequiredEsblib = 1;
...
function requireInternals() {
  ...
  internals = __toCommonJS(internals_exports);
  var locked = false;
...
var vendorCore;
var hasRequiredVendorCore;
function requireVendorCore() {
  if (hasRequiredVendorCore) return vendorCore;
  hasRequiredVendorCore = 1;
  const {
    __create,
    __spreadValues,
    __spreadProps,
  ...
  var require_posix = __commonJS({
    "node_modules/isexe/dist/cjs/posix.js"(exports2) {
      ...
      var fs_1 = require$$5;
      var promises_1 = require$$5.promises;
      var isexe = (_0, ..._1) => __async(null, [_0, ..._1], function* (path2, options = {}) {
  ...
  var require_lib = __commonJS({
    "node_modules/which/lib/index.js"(exports2, module2) {
      ...
      var { join: join2, delimiter, sep, posix } = require$$2;
  ...
  vendorCore = __toCommonJS(vendor_core_exports);
  ...
  var import_node_process = __toESM(require$$3, 1);
  var import_node_os = __toESM(require$$1, 1);
  var import_node_tty = __toESM(require$$5$1, 1);
  ...
  var import_node_process4 = __toESM(require$$3, 1);
  var import_node_fs = __toESM(require$$5, 1);
  var import_node_os2 = __toESM(require$$1, 1);
  var EOL = /\r?\n|\r|\n/;
  var EMPTY = "-";
  ...
  var cp = __toESM(require$$6, 1);
  var import_node_process3 = __toESM(require$$3, 1);
  var import_node_events = __toESM(require$$6$1, 1);
  var import_node_stream = require$$4;
  var import_node_process2 = __toESM(require$$3, 1);
  var g = !import_node_process2.default.versions.deno && commonjsGlobal || globalThis;
  ...
  tree.sync = treeSync;
  var kill2 = (pid, opts, next) => {
    if (typeof opts == "function") {
      return kill2(pid, void 0, opts);
    }
    if (typeof opts == "string" || typeof opts == "number") {
      return kill2(pid, { signal: opts }, next);
    }
  ...
  var identity = (v) => v;
  var index_default = { kill: kill2, lookup, lookupSync, tree, treeSync };
  var import_internals = requireInternals();
  var chalk22 = import_internals.bus.wrap("chalk", source_default);
...
function requireUtil() {
  ...
  util = __toCommonJS(util_exports);
  var import_node_path2 = __toESM(require$$2, 1);
  var import_node_process = __toESM(require$$3, 1);
  var import_vendor_core = requireVendorCore();
  function noop() {
  }
  function identity(v) {
    return v;
  ...
  function preferLocalBin(env, ...dirs) {
    ...
    ).flat().concat(env[pathKey]).filter(Boolean).join(import_node_path2.default.delimiter);
...
function requireCore() {
  ...
  __export(core_exports, {
    ...
    ProcessPromise: () => ProcessPromise2,
    ...
    quote: () => import_util22.quote,
    quotePowerShell: () => import_util22.quotePowerShell,
    resolveDefaults: () => resolveDefaults2,
    syncProcessCwd: () => syncProcessCwd2,
    useBash: () => useBash2,
    usePowerShell: () => usePowerShell2,
    usePwsh: () => usePwsh2,
    which: () => import_vendor_core3.which,
    within: () => within2
  });
  core = __toCommonJS(core_exports);
  var import_node_async_hooks = require$$1$1;
  var import_node_buffer = require$$2$1;
  var import_node_child_process = __toESM(require$$6, 1);
  var import_node_events = require$$6$1;
  var import_node_fs = __toESM(require$$5, 1);
  var import_node_os = require$$1;
  var import_node_process2 = __toESM(require$$3, 1);
  var import_node_util2 = require$$3$1;
  var EXIT_CODES = {
...
${details}`;
  ...
  var Fail2 = _Fail;
  var import_vendor_core = requireVendorCore();
  var import_node_util = require$$3$1;
  var import_node_process = __toESM(require$$3, 1);
  var formatters = {
    cmd({ cmd }) {
...
`;
  ...
  var log2 = function(entry) {
    var _a;
    if (!entry.verbose) return;
    const stream = log2.output || import_node_process.default.stderr;
    const format = ((_a = log2.formatters) == null ? void 0 : _a[entry.kind]) || formatters[entry.kind];
    if (!format) return;
  ...
  var import_vendor_core2 = requireVendorCore();
  var import_util2 = requireUtil();
  var import_internals = requireInternals();
  var import_node_path2 = __toESM(require$$2, 1);
  var os2 = __toESM(require$$1, 1);
  var import_vendor_core3 = requireVendorCore();
  var import_util22 = requireUtil();
  ...
  var defaults2 = resolveDefaults2({
  ...
  var getStore = () => storage.getStore() || defaults2;
  ...
  var $2 = new Proxy(
    ...
    function(pieces, ...args) {
      ...
      if (!Array.isArray(pieces)) {
        return function(...args2) {
          return within2(() => Object.assign($2, opts, pieces).apply(this, args2));
        };
      }
      const from = Fail2.getCallerLocation();
      const cb = () => cb[SHOT] = getSnapshot(opts, from, pieces, args);
      const pp = new ProcessPromise2(cb);
    ...
    },
    {
      ...
      get(t, key) {
        return key === "sync" ? $2({ sync: true }) : Reflect.get(key in Function.prototype ? t : getStore(), key);
      }
    }
  );
  var _ProcessPromise = class _ProcessPromise2 extends Promise {
    constructor(executor) {
      ...
      let reject;
      super((...args) => {
        [resolve = import_util2.noop, reject = import_util2.noop] = args;
        executor(...args);
      });
      this._stage = "initial";
      this._id = (0, import_util2.randomId)();
      this._piped = false;
      ...
      if (snapshot) {
        ...
        try {
          ...
          this.finalize(ProcessOutput2.fromError(err), true);
        }
      } else _ProcessPromise2.disarm(this);
    }
    // prettier-ignore
    build() {
      const $22 = this._snapshot;
      if (!$22.shell)
        throw new Fail2(`No shell is available: ${Fail2.DOCS_URL}/shell`);
      if (!$22.quote)
        throw new Fail2(`No quote function is defined: ${Fail2.DOCS_URL}/quotes`);
      if ($22.pieces.some((p) => p == null))
        throw new Fail2(`Malformed command at ${$22.from}`);
      $22.cmd = (0, import_vendor_core2.buildCmd)(
        $22.quote,
        $22.pieces,
        $22.args
      );
    ...
    run() {
      ...
      this._stage = "running";
      const self2 = this;
      const $22 = self2._snapshot;
      const id = self2.id;
      const cwd = $22.cwd || $22[CWD];
      if ($22.preferLocal) {
        const dirs = $22.preferLocal === true ? [$22.cwd, $22[CWD]] : [$22.preferLocal].flat();
        $22.env = (0, import_util2.preferLocalBin)($22.env, ...dirs);
      }
      this._zurk = (0, import_vendor_core2.exec)({
        cmd: self2.fullCmd,
        cwd,
        input: (_b = (_a = $22.input) == null ? void 0 : _a.stdout) != null ? _b : $22.input,
        stdin: self2._stdin,
        sync: self2.sync,
        signal: self2.signal,
        shell: (0, import_util2.isString)($22.shell) ? $22.shell : true,
        id,
        env: $22.env,
        spawn: $22.spawn,
        ...
        run(cb, ctx) {
          var _a2, _b2;
          ((_b2 = (_a2 = self2.cmd).then) == null ? void 0 : _b2.call(
            _a2,
            (cmd) => {
              $22.cmd = cmd;
            ...
            (error) => self2.finalize(ProcessOutput2.fromError(error))
          )) || cb();
        },
        on: {
          start: () => {
            $22.log({ kind: "cmd", cmd: $22.cmd, cwd, verbose: self2.isVerbose(), id });
            self2.timeout($22.timeout, $22.timeoutSignal);
          },
          stdout: (data) => {
            $22.log({ kind: "stdout", data, verbose: !self2._piped && self2.isVerbose(), id });
          },
          stderr: (data) => {
            $22.log({ kind: "stderr", data, verbose: !self2.isQuiet(), id });
          },
          end: (data, c) => {
            ...
            $22.log({ kind: "end", signal, exitCode: code, duration, error, verbose: self2.isVerbose(), id });
            if (stdout.length && (0, import_util2.getLast)((0, import_util2.getLast)(stdout)) !== BR_CC) c.on.stdout(EOL, c);
            if (stderr.length && (0, import_util2.getLast)((0, import_util2.getLast)(stderr)) !== BR_CC) c.on.stderr(EOL, c);
    ...
    abort(reason) {
      if (this.isSettled()) throw new Fail2("Too late to abort the process.");
      if (this.signal !== this.ac.signal)
        throw new Fail2("The signal is controlled by another process.");
      if (!this.child)
        throw new Fail2("Trying to abort a process without creating one.");
      this.ac.abort(reason);
    }
    kill(signal) {
      if (this.isSettled()) throw new Fail2("Too late to kill the process.");
      if (!this.child)
        throw new Fail2("Trying to kill a process without creating one.");
      if (!this.pid) throw new Fail2("The process pid is undefined.");
      return $2.kill(this.pid, signal || this._snapshot.killSignal || $2.killSignal);
    }
    // Configurators
    stdio(stdin2, stdout = "pipe", stderr = "pipe") {
      this._snapshot.stdio = Array.isArray(stdin2) ? stdin2 : [stdin2, stdout, stderr];
      return this;
    }
    nothrow(v = true) {
    ...
    timeout(d = 0, signal = $2.timeoutSignal) {
      if (this.isSettled()) return this;
      const $22 = this._snapshot;
      $22.timeout = (0, import_util2.parseDuration)(d);
      $22.timeoutSignal = signal;
      if (this._timeoutId) clearTimeout(this._timeoutId);
      if ($22.timeout && this.isRunning()) {
        this._timeoutId = setTimeout(() => this.kill($22.timeoutSignal), $22.timeout);
        this.finally(() => clearTimeout(this._timeoutId)).catch(import_util2.noop);
      }
      return this;
    }
    /**
    ...
    _pipe(source, dest, ...args) {
      if ((0, import_util2.isString)(dest))
        return this._pipe(source, import_node_fs.default.createWriteStream(dest));
      if ((0, import_util2.isStringLiteral)(dest, ...args))
        return this._pipe(
          source,
          $2({
            halt: true,
      ...
      if (isP && dest.isSettled()) throw new Fail2("Cannot pipe to a settled process.");
      if (!isP && dest.writableEnded) throw new Fail2("Cannot pipe to a closed stream.");
      this._piped = true;
      ...
      const check = () => {
        var _a;
        return !!((_a = _ProcessPromise2.bus.refs.get(this)) == null ? void 0 : _a.has(dest));
      };
      const end = () => {
        if (!check()) return;
        setImmediate(() => {
          _ProcessPromise2.bus.unpipe(this, dest);
          _ProcessPromise2.bus.sources(dest).length === 0 && from.end();
        });
      };
      const fill = () => {
    ...
    [Symbol.asyncIterator]() {
      return __asyncGenerator(this, null, function* () {
        const memo = [];
        const dlmtr = this._snapshot.delimiter || $2.delimiter || DLMTR;
        for (const chunk of this._zurk.store.stdout) {
          yield* __yieldStar((0, import_util2.getLines)(chunk, memo, dlmtr));
        }
        try {
    ...
    static disarm(p, toggle = true) {
      Object.getOwnPropertyNames(_ProcessPromise2.prototype).forEach((k) => {
        ...
        Object.defineProperty(p, k, { configurable: true, get() {
          throw new Fail2("Inappropriate usage. Apply $ instead of direct instantiation.");
        } });
      });
    }
  };
  ...
  _ProcessPromise.promisifyStream = (stream, from) => {
    const proxy = _ProcessPromise.bus.streams.get(stream) || (0, import_util2.proxyOverride)(stream, {
      then(res = import_util2.noop, rej = import_util2.noop) {
        return new Promise((_res, _rej) => {
          const end = () => _res(res((0, import_util2.proxyOverride)(stream, from.output)));
  ...
  var ProcessPromise2 = _ProcessPromise;
  var _ProcessOutput = class _ProcessOutput2 extends Error {
    ...
    constructor(code = null, signal = null, stdout = "", stderr = "", stdall = "", message = "", duration = 0, error = null, from = "", store = { stdout: [stdout], stderr: [stderr], stdall: [stdall] }) {
      ...
      Object.defineProperties(this, {
        ...
        stdout: { get: (0, import_util2.once)(() => (0, import_util2.bufArrJoin)(dto.store.stdout)) },
        stderr: { get: (0, import_util2.once)(() => (0, import_util2.bufArrJoin)(dto.store.stderr)) },
        stdall: { get: (0, import_util2.once)(() => (0, import_util2.bufArrJoin)(dto.store.stdall)) },
        message: { get: (0, import_util2.once)(
          () => dto.error || message ? _ProcessOutput2.getErrorMessage(dto.error || new Error(message), dto.from) : _ProcessOutput2.getExitMessage(
            dto.code,
            dto.signal,
            this.stderr,
            dto.from,
            this.stderr.trim() ? "" : _ProcessOutput2.getErrorDetails(this.lines())
          )
        ) }
      });
    }
    ...
    lines(delimiter) {
      return (0, import_util2.iteratorToArray)(this[Symbol.iterator](delimiter));
    }
    toString() {
      return this.stdall;
    }
    ...
    // prettier-ignore
    *[Symbol.iterator](dlmtr = this._dto.delimiter || $2.delimiter || DLMTR) {
      const memo = [];
  ...
  _ProcessOutput.getExitMessage = Fail2.formatExitMessage;
  _ProcessOutput.getErrorMessage = Fail2.formatErrorMessage;
  _ProcessOutput.getErrorDetails = Fail2.formatErrorDetails;
  _ProcessOutput.getExitCodeInfo = Fail2.getExitCodeInfo;
  var ProcessOutput2 = _ProcessOutput;
  var useBash2 = () => setShell("bash", false);
  var usePwsh2 = () => setShell("pwsh");
  var usePowerShell2 = () => setShell("powershell.exe");
  function setShell(n, ps3 = true) {
    $2.shell = import_vendor_core2.which.sync(n);
    $2.prefix = ps3 ? "" : "set -euo pipefail;";
    $2.postfix = ps3 ? "; exit $LastExitCode" : "";
    $2.quote = ps3 ? import_util2.quotePowerShell : import_util2.quote;
  }
  try {
    const { shell, prefix, postfix } = $2;
    useBash2();
    if ((0, import_util2.isString)(shell)) $2.shell = shell;
    if ((0, import_util2.isString)(prefix)) $2.prefix = prefix;
    if ((0, import_util2.isString)(postfix)) $2.postfix = postfix;
  } catch (err) {
  }
  var cwdSyncHook;
  function syncProcessCwd2(flag = true) {
  ...
  function syncCwd() {
    if ($2[CWD] != import_node_process2.default.cwd()) import_node_process2.default.chdir($2[CWD]);
  }
  function cd2(dir) {
    if (dir instanceof ProcessOutput2) {
      dir = dir.toString().trim();
    }
    $2.log({ kind: "cd", dir, verbose: !$2.quiet && $2.verbose });
    import_node_process2.default.chdir(dir);
    $2[CWD] = import_node_process2.default.cwd();
  }
  function kill2(_0) {
    return __async(this, arguments, function* (pid, signal = $2.killSignal || SIGTERM) {
      if (typeof pid !== "number" && typeof pid !== "string" || !/^\d+$/.test(pid))
        throw new Fail2(`Invalid pid: ${pid}`);
      $2.log({ kind: "kill", pid, signal, verbose: !$2.quiet && $2.verbose });
  ...
  function resolveDefaults2(defs = defaults2, prefix = ENV_PREFIX, env = import_node_process2.default.env, allowed = ENV_OPTS) {
    return Object.entries(env).reduce((m, [k, v]) => {
      if (v && k.startsWith(prefix)) {
        const _k = (0, import_util2.toCamelCase)(k.slice(prefix.length));
        const _v = (0, import_util2.parseBool)(v);
...
var vendor = { exports: {} };
var vendorExtra;
var hasRequiredVendorExtra;
function requireVendorExtra() {
  if (hasRequiredVendorExtra) return vendorExtra;
  hasRequiredVendorExtra = 1;
  const {
    __spreadValues,
    __spreadProps,
    __esm,
  ...
  var require_glob_parent = __commonJS({
    "node_modules/glob-parent/index.js"(exports2, module2) {
      ...
      var pathPosixDirname = require$$2.posix.dirname;
  ...
  var require_queue_microtask = __commonJS({
    "node_modules/queue-microtask/index.js"(exports2, module2) {
      var promise;
      module2.exports = typeof queueMicrotask === "function" ? queueMicrotask.bind(typeof window !== "undefined" ? window : commonjsGlobal) : (cb) => (promise || (promise = Promise.resolve())).then(cb).catch((err) => setTimeout(() => {
        throw err;
      }, 0));
    }
  });
  ...
  var require_graceful_fs = __commonJS({
    "node_modules/graceful-fs/graceful-fs.js"(exports2, module2) {
      ...
      if (!fs6[gracefulQueue]) {
        queue = commonjsGlobal[gracefulQueue] || [];
        ...
        if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || "")) {
          process.on("exit", function() {
            ...
            require$$8.equal(fs6[gracefulQueue].length, 0);
          });
        }
      }
      var queue;
      if (!commonjsGlobal[gracefulQueue]) {
        publishQueue(commonjsGlobal, fs6[gracefulQueue]);
      }
  ...
  var init_node_fetch_native_DfbY2q_x = __esm({
    "node_modules/node-fetch-native/dist/shared/node-fetch-native.DfbY2q-x.mjs"() {
      ...
      n = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof commonjsGlobal < "u" ? commonjsGlobal : typeof self < "u" ? self : {};
  ...
  var B, E, D, t2, w, R, g, N, x, P, C, I, M, $2, m, F, k;
...
`)).replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22"), "e$1");
      ...
      $22 = /* @__PURE__ */ Symbol("Request internals");
      qt = n2((i) => typeof i == "object" && typeof i[$22] == "object", "isRequest");
      ...
      hl = n2((i) => {
        const { parsedURL: o3 } = i[$22], a = new ye(i[$22].headers);
        ...
        f2 && a.set("Content-Length", f2), i.referrerPolicy === "" && (i.referrerPolicy = sl), i.referrer && i.referrer !== "no-referrer" ? i[$22].referrer = fl(i) : i[$22].referrer = "no-referrer", i[$22].referrer instanceof URL && a.set("Referer", i.referrer), a.has("User-Agent") || a.set("User-Agent", "node-fetch"), i.compress && !a.has("Accept-Encoding") && a.set("Accept-Encoding", "gzip, deflate, br");
        let { agent: l } = i;
  ...
  vendorExtra = __toCommonJS(vendor_extra_exports);
  var import_node_process2 = __toESM(require$$3, 1);
  var import_node_fs3 = __toESM(require$$5, 1);
  var import_node_path2 = __toESM(require$$2, 1);
  var import_node_stream2 = require$$4;
  var import_node_events = require$$6$1;
  var import_node_stream = require$$4;
  var import_promises = require$$4.promises;
  ...
  var import_node_fs = __toESM(require$$5, 1);
  var import_promises2 = __toESM(require$$5.promises, 1);
  ...
  var import_node_util = require$$3$1;
  var import_node_child_process = require$$6;
  var import_node_url = require$$17;
  ...
  var import_node_process = __toESM(require$$3, 1);
  var import_node_fs2 = __toESM(require$$5, 1);
  var import_promises3 = __toESM(require$$5.promises, 1);
  var import_node_path4 = __toESM(require$$2, 1);
...
${end.comment}` : end.comment;
  ...
  var import_node_fs5 = __toESM(require$$5, 1);
  var import_node_path42 = __toESM(require$$2, 1);
  var import_node_util3 = require$$3$1;
  var DOTENV = ".env";
  var Q1 = '"';
  var Q2 = "'";
  var Q3 = "`";
  ...
  var globalVar = "Deno" in globalThis ? globalThis : commonjsGlobal;
  ...
  var _glob = Object.assign(function globby22(patterns, options) {
...
function requireVendor() {
  if (hasRequiredVendor) return vendor.exports;
  hasRequiredVendor = 1;
  (function(module) {
    const {
      __reExport,
    ...
    __reExport(vendor_exports, requireVendorCore(), module.exports);
    __reExport(vendor_exports, requireVendorExtra(), module.exports);
  })(vendor);
...
function requireBuild() {
  ...
  (function(module) {
    ...
    __export(index_exports, {
      ...
      tmpdir: () => tempdir2,
      tmpfile: () => tempfile2,
      updateArgv: () => updateArgv2,
      version: () => version2,
      versions: () => versions2
    });
    module.exports = __toCommonJS(index_exports);
    var import_core2 = requireCore();
    var import_node_buffer = require$$2$1;
    var import_node_process = __toESM(require$$3, 1);
    var import_node_readline = require$$4$1;
    var import_node_stream = require$$4;
    var import_core = requireCore();
    var import_util2 = requireUtil();
    var import_vendor = requireVendor();
    var versions2 = {
      zx: "8.8.5",
      chalk: "5.6.2",
      depseek: "0.4.3",
    ...
    function tempdir2(prefix = `zx-${(0, import_util2.randomId)()}`, mode) {
    ...
    function tempfile2(name, data, mode) {
      const filepath = name ? import_core.path.join(tempdir2(), name) : import_core.path.join(import_core.os.tmpdir(), `zx-${(0, import_util2.randomId)()}`);
    ...
    var parseArgv2 = (args = import_node_process.default.argv.slice(2), opts = {}, defs = {}) => Object.entries((0, import_vendor.minimist)(args, opts)).reduce(
      (m, [k, v]) => {
        const kTrans = opts.camelCase ? import_util2.toCamelCase : import_util2.identity;
        const vTrans = opts.parseBoolean ? import_util2.parseBool : import_util2.identity;
    ...
    function updateArgv2(args, opts) {
      for (const k in argv2) delete argv2[k];
      parseArgv2(args, opts, argv2);
    }
    var argv2 = parseArgv2();
    function sleep2(duration) {
      return new Promise((resolve) => {
        setTimeout(resolve, (0, import_util2.parseDuration)(duration));
      });
    }
    ...
    function fetch2(url, init) {
      ...
      return Object.assign(p, {
        pipe(dest, ...args) {
          ...
          const _dest = (0, import_util2.isStringLiteral)(dest, ...args) ? (0, import_core.$)({
            halt: true,
    ...
    function echo2(pieces, ...args) {
      const msg = (0, import_util2.isStringLiteral)(pieces, ...args) ? args.map((a, i) => pieces[i] + stringify(a)).join("") + (0, import_util2.getLast)(pieces) : [pieces, ...args].map(stringify).join(" ");
      console.log(msg);
    }
    function stringify(arg) {
      return arg instanceof import_core.ProcessOutput ? arg.toString().trimEnd() : `${arg}`;
    }
    function question2(_0) {
      ...
      return __async(this, null, function* () {
        ...
        while (count-- > 0) {
          ...
          try {
            ...
            if (delay > 0) yield sleep2(delay);
          }
        }
        throw lastErr;
      });
    }
    function* expBackoff2(max = "60s", delay = "100ms") {
      const maxMs = (0, import_util2.parseDuration)(max);
      const randMs = (0, import_util2.parseDuration)(delay);
      let n = 0;
      while (true) {
        yield Math.min(randMs * __pow(2, n++), maxMs);
      }
    }
    function spinner2(title, callback) {
      return __async(this, null, function* () {
        if (typeof title === "function") return spinner2("", title);
    ...
    __reExport(index_exports, requireCore(), module.exports);
    var import_vendor2 = requireVendor();
    import_core2.bus.lock();
    var VERSION2 = versions2.zx || "0.0.0";
    var version2 = VERSION2;
    function nothrow2(promise) {
      return promise.nothrow();
    }
    function quiet2(promise) {
...
const __module__ = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null
}, [buildExports]);
const {
  VERSION,
...
const ssl = {
  async generateKey(outputPath) {
    await $`openssl genrsa -out ${outputPath} 2048`;
  },
  async generateCsr(keyPath, outputPath, commonName) {
    await $`openssl req -new -key ${keyPath} -out ${outputPath} -subj "/CN=${commonName}"`;
  },
  async generateP12(outputPath, keyPath, pemPath) {
...
class GitHubSshGenerator {
  async run() {
    cli.printSection("GitHub SSH Onboarding");
    const defaultSshDir = join(os.homedir(), ".ssh");
...
class MtlsGenerator {
  async generateCertificates(config) {
    ...
    const csrPath = join(certDir, "client.csr");
  ...
  async generateAppleProfile(config) {
    cli.printSection("Apple Profile");
    const certDir = join(config.workDir, "tunnel_cert");
    const p12Path = join(certDir, "device-cert.p12");
    const profilePath = join(certDir, "apple-secure.mobileconfig");
    const keyPath = join(certDir, "client.key");
    const pemPath = join(certDir, "client.pem");
...
class PortalGenerator {
  async run(config) {
    ...
    const fbDir = join(config.workDir, "filebrowser", "conf");
    const srvDir = join(config.workDir, "filebrowser", "srv");
...
const registerPortalMenu = (menu, config) => {
...
async function main() {
  ...
  const setupCommonConfig = async () => {
    const defaultWorkDir = join(os.homedir(), "git");
